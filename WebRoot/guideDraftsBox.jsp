...
<%
	...
	System.out.println("guideDraftsBox..."+gphone);
	List<Tourarrangement> draftsDroductAll = new ArrayList<Tourarrangement>(); 
	Guide g = new Guide();
	GuideBiz gb = new GuideBizImpl();
	/* g = gb.getGuideInfo(gphone); */
	draftsDroductAll = gb.ShowDraftsProduct(gphone);
%>
...
<head>
    ...
    <link rel="stylesheet" href="css/views/guideDraftsBox.css">
...
<body>
    ...
    <div class="mainContent">
        ...
        <%
    		for(Tourarrangement tour :draftsDroductAll){
     	%>
            <div class="toulist-box" data-tour-id="<%=tour.getId() %>">
                <div class="img-box">
    ...
    <script src="js/views/guideDraftsBox.js"></script>
</body>
