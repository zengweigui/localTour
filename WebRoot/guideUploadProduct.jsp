...
<%
	...
	System.out.println("guideUploadProduct..."+gphone);
%>
...
<head>
    ...
    <link rel="stylesheet" href="css/views/guideUploadProduct.css">
...
<body>
    ...
    <div class="mainContent">
        ...
        <div class="addProduct-content clearfix">
            <div class="product-bg-big-box">
                ...
                <img class="product-bg" src="" />
                <div class="set-title">
                    <input id="product-title" value="" placeholder="填写产品标题" maxlength="36" type="text">
                </div>
            </div>
            <div class="product-information clearfix">
                <div class="information-box">
                    ...
                    <div class="input-information">
                        <input class="product-price" type="number" name="价格" placeholder="请输入价格" />
                    </div>
                </div>
                <div class="information-box">
                    <span class="information-tit">库存</span>
                    <div class="input-information">
                        <input class="product-stock" type="number" name="库存" placeholder="请输入库存" />
                    </div>
                </div>
                <div class="information-box">
            ...
            <div class="booking-information">
                ...
                <textarea class="cost-includes" maxlength="1000" placeholder="请输入费用包含"></textarea>
                ...
                <textarea class="remark-information" maxlength="1000" placeholder="请输入备注说明"></textarea>
            </div>
    ...
    <script src="js/views/guideUploadProduct.js"></script>
</body>
